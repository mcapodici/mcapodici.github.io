...
var _elm_lang$elm_architecture_tutorial$Persistence_Interface$Persister = F3(
	function (a, b, c) {
		return {encode: a, decoder: b, className: c};
	});
var _elm_lang$elm_architecture_tutorial$Persistence_Interface$Clause = F2(
	function (a, b) {
		return {fieldName: a, value: b};
	});
var _elm_lang$elm_architecture_tutorial$Persistence_Interface$BaaSPersister = F4(
	function (a, b, c, d) {
		return {save: a, get: b, update: c, $delete: d};
	});

var _elm_lang$elm_architecture_tutorial$PersistableData$Transaction = F7(
	function (a, b, c, d, e, f, g) {
		return {storedKey: a, desc: b, amount: c, accountKey: d, payeeAccountKey: e, categoryKey: f, date: g};
	});
var _elm_lang$elm_architecture_tutorial$PersistableData$Account = F2(
	function (a, b) {
		return {storedKey: a, name: b};
	});
var _elm_lang$elm_architecture_tutorial$PersistableData$Category = F2(
	function (a, b) {
		return {storedKey: a, name: b};
	});

var _elm_lang$elm_architecture_tutorial$EditableGrid_Interface$withStoredKey_Transaction = {
	get: function (_) {
		return _.storedKey;
	},
	set: F2(
...
var _elm_lang$elm_architecture_tutorial$EditableGrid_Interface$withStoredKey_Category = {
	get: function (_) {
		return _.storedKey;
	},
	set: F2(
...
var _elm_lang$elm_architecture_tutorial$EditableGrid_Interface$withStoredKey_Account = {
	get: function (_) {
		return _.storedKey;
	},
	set: F2(
...
var _elm_lang$elm_architecture_tutorial$EditableGrid_Interface$ToFromEditable = F2(
	function (a, b) {
		return {toEditable: a, toData: b};
	});
var _elm_lang$elm_architecture_tutorial$EditableGrid_Interface$WithStoredKey = F2(
	function (a, b) {
		return {get: a, set: b};
	});
var _elm_lang$elm_architecture_tutorial$EditableGrid_Interface$WithLocalId = F2(
	function (a, b) {
		return {get: a, set: b};
	});

var _elm_lang$elm_architecture_tutorial$Accounts_Model$toFromEditable_Account = {
	toEditable: function (data) {
		return {storedKey: data.storedKey, name: data.name};
	},
	toData: function (row) {
		return {storedKey: row.storedKey, name: row.name};
	}
};
var _elm_lang$elm_architecture_tutorial$Accounts_Model$withLocalId_AccountPageModel = {
	get: function (_) {
		return _.nextFakeId;
	},
	set: F2(
...
var _elm_lang$elm_architecture_tutorial$Accounts_Model$withStoredKey_EditingAccountRow = {
	get: function (_) {
		return _.storedKey;
	},
	set: F2(
...
var _elm_lang$elm_architecture_tutorial$Accounts_Model$EditingAccountRow = F2(
	function (a, b) {
		return {storedKey: a, name: b};
	});
var _elm_lang$elm_architecture_tutorial$Accounts_Model$AccountPageModel = F3(
	function (a, b, c) {
		return {editingAccountRow: a, confirmDeleteKey: b, nextFakeId: c};
	});

var _elm_lang$elm_architecture_tutorial$Accounts_Message$NoOp = {ctor: 'NoOp'};
var _elm_lang$elm_architecture_tutorial$Accounts_Message$StorageFailed = function (a) {
	return {ctor: 'StorageFailed', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Accounts_Message$StorageSaveSuccess = F2(
	function (a, b) {
		return {ctor: 'StorageSaveSuccess', _0: a, _1: b};
	});
var _elm_lang$elm_architecture_tutorial$Accounts_Message$StorageDeleteSuccess = {ctor: 'StorageDeleteSuccess'};
var _elm_lang$elm_architecture_tutorial$Accounts_Message$StorageUpdateSuccess = {ctor: 'StorageUpdateSuccess'};
var _elm_lang$elm_architecture_tutorial$Accounts_Message$SetAccountName = function (a) {
	return {ctor: 'SetAccountName', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Accounts_Message$DoubleClickAccount = F2(
	function (a, b) {
		return {ctor: 'DoubleClickAccount', _0: a, _1: b};
	});
var _elm_lang$elm_architecture_tutorial$Accounts_Message$CancelDelete = {ctor: 'CancelDelete'};
var _elm_lang$elm_architecture_tutorial$Accounts_Message$DeleteAccount = F2(
	function (a, b) {
		return {ctor: 'DeleteAccount', _0: a, _1: b};
	});
var _elm_lang$elm_architecture_tutorial$Accounts_Message$EditAccount = function (a) {
	return {ctor: 'EditAccount', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Accounts_Message$CancelAccount = {ctor: 'CancelAccount'};
var _elm_lang$elm_architecture_tutorial$Accounts_Message$SaveAccount = function (a) {
	return {ctor: 'SaveAccount', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Accounts_Message$AddAccount = {ctor: 'AddAccount'};
...
var _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$appendToURL = F2(
	function (url, str) {
		return _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$trailingSlash(
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$trailingSlash(url),
				str));
	});
var _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$pathURL = F2(
	function (url, pathList) {
		return A3(
			_elm_lang$core$List$foldl,
			_elm_lang$core$Basics$flip(_elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$appendToURL),
			url,
			pathList);
	});
var _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$removeTrailingSlash = function (url) {
	return A2(_elm_lang$core$String$endsWith, '/', url) ? A3(
		_elm_lang$core$String$slice,
		0,
		_elm_lang$core$String$length(url) - 1,
		url) : url;
};
var _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$headers = function (creds) {
	return {
		ctor: '::',
		_0: A2(_elm_lang$http$Http$header, 'X-Parse-Application-Id', creds.appId),
		_1: {
			ctor: '::',
			_0: A2(_elm_lang$http$Http$header, 'X-Parse-REST-API-Key', creds.apiKey),
			_1: {ctor: '[]'}
		}
	};
};
var _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$delete = F3(
	function (credentials, $class, key) {
		return _elm_lang$http$Http$toTask(
			_elm_lang$http$Http$request(
				{
					method: 'DELETE',
					headers: _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$headers(credentials),
					expect: _elm_lang$http$Http$expectStringResponse(
						function (_p0) {
							return _elm_lang$core$Result$Ok(
								{ctor: '_Tuple0'});
						}),
					url: _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$removeTrailingSlash(
						A2(
...
var _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$query = F4(
	function (credentials, $class, query, decoder) {
		var queryString = A3(
			_elm_lang$core$List$foldl,
			F2(
				function (_p1, queryString) {
					var _p2 = _p1;
					return A3(
						_Bogdanp$elm_querystring$QueryString$add,
						_p2._0,
						A2(_elm_lang$core$Json_Encode$encode, 0, _p2._1),
						queryString);
				}),
			_Bogdanp$elm_querystring$QueryString$empty,
			query);
			...
			_elm_lang$http$Http$request(
				{
					...
					headers: {
						...
						_1: _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$headers(credentials)
					},
...
var _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$get = F5(
	function (credentials, $class, objectId, decoder, onResult) {
		return A2(
...
var _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$ParseSdk = F5(
	function (a, b, c, d, e) {
		return {create: a, query: b, get: c, update: d, $delete: e};
	});
var _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$Credentials = F3(
	function (a, b, c) {
		return {appId: a, apiKey: b, url: c};
	});
var _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$CreateResponse = F2(
	function (a, b) {
		return {createdAt: a, objectId: b};
	});
var _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$createResponseDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$CreateResponse,
	A2(
		_elm_lang$core$Json_Decode$map,
		function (s) {
...
var _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$create = F3(
			...
			_elm_lang$http$Http$request(
				{
					method: 'POST',
					headers: _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$headers(credentials),
					expect: _elm_lang$http$Http$expectJson(_elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$createResponseDecoder),
					url: A2(
						_elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$pathURL,
						credentials.url,
						{
...
var _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$UpdateResponse = function (a) {
	return {updatedAt: a};
};
var _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$updateResponseDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	_elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$UpdateResponse,
	A2(
		_elm_lang$core$Json_Decode$map,
		function (s) {
			return _elm_lang$core$Date$fromTime(0);
		},
		A2(_elm_lang$core$Json_Decode$field, 'updatedAt', _elm_lang$core$Json_Decode$string)));
var _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$update = F4(
	function (credentials, $class, key, value) {
		return _elm_lang$http$Http$toTask(
			_elm_lang$http$Http$request(
				{
					method: 'PUT',
					headers: _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$headers(credentials),
					expect: _elm_lang$http$Http$expectJson(_elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$updateResponseDecoder),
					url: A2(
						_elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$pathURL,
						credentials.url,
						{
...
var _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$init = function (credentials) {
	return {
		create: _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$create(credentials),
		query: _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$query(credentials),
		get: _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$get(credentials),
		update: _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$update(credentials),
		$delete: _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$delete(credentials)
	};
};
var _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$Options = F6(
...
var _elm_lang$elm_architecture_tutorial$Persistence_ParseBaaS$update = F4(
	function (credentials, persister, key, object) {
		var sdk = _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$init(credentials);
		return A2(
			_elm_lang$core$Task$mapError,
			_elm_lang$elm_architecture_tutorial$Persistence_ParseBaaS$httpErrorMapper,
...
var _elm_lang$elm_architecture_tutorial$Persistence_ParseBaaS$get = F3(
	function (credentials, persister, clauses) {
		var queryJson = _elm_lang$core$Json_Encode$object(
			A2(
				_elm_lang$core$List$map,
				function (clause) {
					return {ctor: '_Tuple2', _0: clause.fieldName, _1: clause.value};
				},
				clauses));
		var sdk = _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$init(credentials);
		return A2(
			...
			A3(
				...
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'where', _1: queryJson},
					_1: {ctor: '[]'}
				},
				persister.decoder));
	});
var _elm_lang$elm_architecture_tutorial$Persistence_ParseBaaS$delete = F3(
	function (credentials, persister, key) {
		var sdk = _elm_lang$elm_architecture_tutorial$Backend_ParseBaaSClient$init(credentials);
		return A2(
			_elm_lang$core$Task$mapError,
			_elm_lang$elm_architecture_tutorial$Persistence_ParseBaaS$httpErrorMapper,
			A2(sdk.$delete, persister.className, key));
	});
var _elm_lang$elm_architecture_tutorial$Persistence_ParseBaaS$persister = F2(
	function (creds, persister) {
		return {
			save: A2(_elm_lang$elm_architecture_tutorial$Persistence_ParseBaaS$save, creds, persister),
			get: A2(_elm_lang$elm_architecture_tutorial$Persistence_ParseBaaS$get, creds, persister),
			update: A2(_elm_lang$elm_architecture_tutorial$Persistence_ParseBaaS$update, creds, persister),
			$delete: A2(_elm_lang$elm_architecture_tutorial$Persistence_ParseBaaS$delete, creds, persister)
		};
	});

var _elm_lang$elm_architecture_tutorial$Persistence_Data$transactionPersister = {
	encode: function (txn) {
		return _elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'desc',
					_1: _elm_lang$core$Json_Encode$string(txn.desc)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'amount',
						_1: _elm_lang$core$Json_Encode$float(txn.amount)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'accountKey',
							_1: _elm_lang$core$Json_Encode$string(txn.accountKey)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'payeeAccountKey',
								_1: _elm_lang$core$Json_Encode$string(txn.payeeAccountKey)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'categoryKey',
									_1: _elm_lang$core$Json_Encode$string(txn.categoryKey)
								},
								_1: {
									ctor: '::',
									_0: {
										...
										_1: _elm_lang$core$Json_Encode$float(
											_elm_lang$core$Date$toTime(txn.date))
									},
									_1: {ctor: '[]'}
								}
							}
	...
	decoder: A8(
		...
		_elm_lang$elm_architecture_tutorial$PersistableData$Transaction,
		A2(_elm_lang$core$Json_Decode$field, 'objectId', _elm_lang$core$Json_Decode$string),
		...
		A2(_elm_lang$core$Json_Decode$field, 'accountKey', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'payeeAccountKey', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'categoryKey', _elm_lang$core$Json_Decode$string),
		A2(
			_elm_lang$core$Json_Decode$map,
...
var _elm_lang$elm_architecture_tutorial$Persistence_Data$categoryPersister = {
	encode: function (acc) {
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'name',
					_1: _elm_lang$core$Json_Encode$string(acc.name)
				},
				_1: {ctor: '[]'}
			});
	},
	decoder: A3(
		_elm_lang$core$Json_Decode$map2,
		_elm_lang$elm_architecture_tutorial$PersistableData$Category,
		A2(_elm_lang$core$Json_Decode$field, 'objectId', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string)),
	className: 'Category'
};
var _elm_lang$elm_architecture_tutorial$Persistence_Data$accountPersister = {
	encode: function (acc) {
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
	...
	decoder: A3(
		_elm_lang$core$Json_Decode$map2,
		_elm_lang$elm_architecture_tutorial$PersistableData$Account,
		A2(_elm_lang$core$Json_Decode$field, 'objectId', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string)),
	className: 'Account'
};

var _elm_lang$elm_architecture_tutorial$ProgramData$credentials = {appId: 'faabd641-fc7a-488d-bb52-bd74ef01a1df', apiKey: 'ahNm3J3SB6GdtOEhHZIsuZDE1yNCSNQL', url: 'https://parse.buddy.com/parse'};
var _elm_lang$elm_architecture_tutorial$ProgramData$programData = {
	accountBaaSPersister: A2(_elm_lang$elm_architecture_tutorial$Persistence_ParseBaaS$persister, _elm_lang$elm_architecture_tutorial$ProgramData$credentials, _elm_lang$elm_architecture_tutorial$Persistence_Data$accountPersister),
	categoryBaaSPersister: A2(_elm_lang$elm_architecture_tutorial$Persistence_ParseBaaS$persister, _elm_lang$elm_architecture_tutorial$ProgramData$credentials, _elm_lang$elm_architecture_tutorial$Persistence_Data$categoryPersister),
	transactionBaaSPersister: A2(_elm_lang$elm_architecture_tutorial$Persistence_ParseBaaS$persister, _elm_lang$elm_architecture_tutorial$ProgramData$credentials, _elm_lang$elm_architecture_tutorial$Persistence_Data$transactionPersister)
};
var _elm_lang$elm_architecture_tutorial$ProgramData$ProgramData = F3(
	function (a, b, c) {
		return {accountBaaSPersister: a, categoryBaaSPersister: b, transactionBaaSPersister: c};
	});

var _elm_lang$elm_architecture_tutorial$Helper_Task$attempt2 = F2(
	function (errorMap, successMap) {
		return _elm_lang$core$Task$attempt(
			function (result) {
				var _p0 = result;
				if (_p0.ctor === 'Ok') {
					return successMap(_p0._0);
				} else {
					return errorMap(_p0._0);
				}
			});
	});
															...
															_0: A2(
																...
																_wittjosiah$elm_alerts$Alert_Stylesheets$InfoAlert,
																{
																	...
																	_0: _rtfeldman$elm_css$Css$backgroundColor(
																		A3(_rtfeldman$elm_css$Css$rgb, 217, 237, 247)),
																	_1: {
																		ctor: '::',
																		_0: A3(
																			...
																			A3(_rtfeldman$elm_css$Css$rgb, 202, 234, 244)),
																		_1: {
																			ctor: '::',
																			_0: _rtfeldman$elm_css$Css$color(
																				A3(_rtfeldman$elm_css$Css$rgb, 49, 114, 150)),
																			_1: {ctor: '[]'}
																		}
																	}
																}),
															_1: {
																...
																_0: A2(
																	...
																	_wittjosiah$elm_alerts$Alert_Stylesheets$SuccessAlert,
																	{
																		ctor: '::',
																		_0: _rtfeldman$elm_css$Css$backgroundColor(
																			A3(_rtfeldman$elm_css$Css$rgb, 221, 238, 214)),
																		_1: {
																			ctor: '::',
																			_0: A3(
																				_rtfeldman$elm_css$Css$border3,
																				_rtfeldman$elm_css$Css$px(1),
																				_rtfeldman$elm_css$Css$solid,
																				A3(_rtfeldman$elm_css$Css$rgb, 206, 224, 192)),
																			_1: {
																				ctor: '::',
																				_0: _rtfeldman$elm_css$Css$color(
																					A3(_rtfeldman$elm_css$Css$rgb, 60, 118, 61)),
																				_1: {ctor: '[]'}
																			}
																		}
																	}),
																_1: {
																	...
																	_0: A2(
																		...
																		_wittjosiah$elm_alerts$Alert_Stylesheets$WarningAlert,
																		{
																			ctor: '::',
																			_0: _rtfeldman$elm_css$Css$backgroundColor(
																				A3(_rtfeldman$elm_css$Css$rgb, 252, 248, 227)),
																			_1: {
																				ctor: '::',
																				_0: A3(
																					_rtfeldman$elm_css$Css$border3,
																					_rtfeldman$elm_css$Css$px(1),
																					_rtfeldman$elm_css$Css$solid,
																					A3(_rtfeldman$elm_css$Css$rgb, 251, 241, 215)),
																				_1: {
																					ctor: '::',
																					_0: _rtfeldman$elm_css$Css$color(
																						A3(_rtfeldman$elm_css$Css$rgb, 138, 109, 59)),
																					_1: {ctor: '[]'}
																				}
																			}
																		}),
																	_1: {
																		...
																		_0: A2(
																			...
																			_wittjosiah$elm_alerts$Alert_Stylesheets$ErrorAlert,
																			{
																				ctor: '::',
																				_0: _rtfeldman$elm_css$Css$backgroundColor(
																					A3(_rtfeldman$elm_css$Css$rgb, 242, 222, 222)),
																				_1: {
																					ctor: '::',
																					_0: A3(
																						_rtfeldman$elm_css$Css$border3,
																						_rtfeldman$elm_css$Css$px(1),
																						_rtfeldman$elm_css$Css$solid,
																						A3(_rtfeldman$elm_css$Css$rgb, 235, 204, 204)),
																					_1: {
																						ctor: '::',
																						_0: _rtfeldman$elm_css$Css$color(
																							A3(_rtfeldman$elm_css$Css$rgb, 132, 53, 52)),
																						_1: {ctor: '[]'}
																					}
																				}
																			}),
...
var _wittjosiah$elm_alerts$Alert$styles = {
	...
	full: {
		ctor: '::',
		_0: _mdgriffith$elm_style_animation$Animation$height(
			_mdgriffith$elm_style_animation$Animation$px(50.0)),
		_1: {ctor: '[]'}
	},
	bare: {
		ctor: '::',
		_0: _mdgriffith$elm_style_animation$Animation$paddingTop(
			_mdgriffith$elm_style_animation$Animation$px(0.0)),
		_1: {
			ctor: '::',
			_0: _mdgriffith$elm_style_animation$Animation$paddingBottom(
				_mdgriffith$elm_style_animation$Animation$px(0.0)),
			_1: {ctor: '[]'}
		}
	},
	padded: {
		ctor: '::',
		_0: _mdgriffith$elm_style_animation$Animation$paddingTop(
			_mdgriffith$elm_style_animation$Animation$px(15.0)),
		_1: {
			ctor: '::',
			_0: _mdgriffith$elm_style_animation$Animation$paddingBottom(
				_mdgriffith$elm_style_animation$Animation$px(15.0)),
...
var _wittjosiah$elm_alerts$Alert$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			case 'AddAlert':
				var padding = model.useAnimations ? A3(
					_elm_lang$core$Dict$insert,
					model.nextKey,
					A2(
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							alerts: A3(_elm_lang$core$Dict$insert, model.nextKey, _p1._0, model.alerts),
							nextKey: model.nextKey + 1,
							opacity: opacity,
							height: height,
							padding: padding,
							spinner: A3(_elm_lang$core$Dict$insert, model.nextKey, _damienklinnert$elm_spinner$Spinner$init, model.spinner)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'RemoveAlert':
				var alerts = A3(
					...
					function (maybeAlert) {
						...
						if (_p2.ctor === 'Nothing') {
							...
							return model.useAnimations ? _elm_lang$core$Maybe$Just(
								_elm_lang$core$Native_Utils.update(
									_p2._0,
									{untilRemove: 1})) : _elm_lang$core$Maybe$Nothing;
						}
					},
					model.alerts);
				return {
			...
			case 'ClearAll':
				var alerts = _elm_lang$core$Dict$fromList(
					A2(
						_elm_lang$core$List$filter,
						function (_p3) {
							var _p4 = _p3;
			...
			case 'Tick':
				var tick = A2(
					...
					function (_p5) {
						...
						var _p8 = _p6._0;
						var _p7 = _p6._1;
						return (_elm_lang$core$Native_Utils.cmp(_p7.untilRemove, 0) > -1) ? {
							ctor: '_Tuple2',
							_0: _p8,
							_1: _elm_lang$core$Native_Utils.update(
								_p7,
								{untilRemove: _p7.untilRemove - 1})
				...
				var removing = A2(
					...
					function (_p9) {
						var _p10 = _p9;
						return _elm_lang$core$Native_Utils.eq(_p10._1.untilRemove, 0);
					},
					tick);
				var opacity = A3(
					_elm_lang$core$List$foldl,
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							alerts: _elm_lang$core$Dict$fromList(tick),
							opacity: opacity,
							height: height,
							padding: padding
						}),
			...
			case 'OpacityAnim':
				var _p22 = _p1._0;
				var opacity = A2(_elm_lang$core$Dict$get, _p22, model.opacity);
				var _p20 = opacity;
				if (_p20.ctor === 'Nothing') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var _p21 = A2(_mdgriffith$elm_style_animation$Animation_Messenger$update, _p1._1, _p20._0);
					var anim = _p21._0;
					var cmd = _p21._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								opacity: A3(_elm_lang$core$Dict$insert, _p22, anim, model.opacity)
							}),
						_1: cmd
					};
				}
			case 'HeightAnim':
				var _p25 = _p1._0;
				var height = A2(_elm_lang$core$Dict$get, _p25, model.height);
				var _p23 = height;
				if (_p23.ctor === 'Nothing') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var _p24 = A2(_mdgriffith$elm_style_animation$Animation_Messenger$update, _p1._1, _p23._0);
					var anim = _p24._0;
					var cmd = _p24._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								height: A3(_elm_lang$core$Dict$insert, _p25, anim, model.height)
							}),
						_1: cmd
					};
				}
			case 'PaddingAnim':
				var _p28 = _p1._0;
				var padding = A2(_elm_lang$core$Dict$get, _p28, model.padding);
				var _p26 = padding;
				if (_p26.ctor === 'Nothing') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var _p27 = A2(_mdgriffith$elm_style_animation$Animation_Messenger$update, _p1._1, _p26._0);
					var anim = _p27._0;
					var cmd = _p27._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								padding: A3(_elm_lang$core$Dict$insert, _p28, anim, model.padding)
							}),
						_1: cmd
					};
				}
			case 'SpinnerMsg':
				var _p30 = _p1._0;
				var spinner = A2(_elm_lang$core$Dict$get, _p30, model.spinner);
				var _p29 = spinner;
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								spinner: A3(
									_elm_lang$core$Dict$insert,
									_p30,
									A2(_damienklinnert$elm_spinner$Spinner$update, _p1._1, _p29._0),
									model.spinner)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			default:
				var _p33 = _p1._0;
				var _p31 = A2(_elm_lang$core$Dict$get, _p33, model.remove);
				if (_p31.ctor === 'Nothing') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								remove: A3(_elm_lang$core$Dict$insert, _p33, 1, model.remove)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var _p32 = _p31._0;
					return _elm_lang$core$Native_Utils.eq(_p32, 2) ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								alerts: A2(_elm_lang$core$Dict$remove, _p33, model.alerts),
								opacity: A2(_elm_lang$core$Dict$remove, _p33, model.opacity),
								height: A2(_elm_lang$core$Dict$remove, _p33, model.height),
								padding: A2(_elm_lang$core$Dict$remove, _p33, model.padding),
								remove: A2(_elm_lang$core$Dict$remove, _p33, model.remove),
								spinner: A2(_elm_lang$core$Dict$remove, _p33, model.spinner)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					} : {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								remove: A3(_elm_lang$core$Dict$insert, _p33, _p32 + 1, model.remove)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
...
var _wittjosiah$elm_alerts$Alert$subscriptions = function (model) {
	...
	var padding = A2(
		...
		_elm_lang$core$Dict$toList(model.padding));
	var height = A2(
		_elm_lang$core$List$map,
		function (_p38) {
			var _p39 = _p38;
		...
		_elm_lang$core$Dict$toList(model.height));
	var opacity = A2(
		_elm_lang$core$List$map,
		function (_p40) {
			var _p41 = _p40;
...
var _wittjosiah$elm_alerts$Alert$alertView = F6(
	function (useAnimations, opacity, height, padding, spinner, _p42) {
		var _p43 = _p42;
		var _p46 = _p43._0;
		var alertPadding = _elm_lang$core$Native_Utils.eq(useAnimations, true) ? A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '[]'},
			A2(
				_elm_lang$core$Maybe$map,
				_mdgriffith$elm_style_animation$Animation$render,
				A2(_elm_lang$core$Dict$get, _p46, padding))) : {ctor: '[]'};
		var alertHeight = _elm_lang$core$Native_Utils.eq(useAnimations, true) ? A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '[]'},
			A2(
				_elm_lang$core$Maybe$map,
				_mdgriffith$elm_style_animation$Animation$render,
				A2(_elm_lang$core$Dict$get, _p46, height))) : {ctor: '[]'};
		var alertOpacity = _elm_lang$core$Native_Utils.eq(useAnimations, true) ? A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '[]'},
			A2(
				_elm_lang$core$Maybe$map,
				_mdgriffith$elm_style_animation$Animation$render,
				A2(_elm_lang$core$Dict$get, _p46, opacity))) : {ctor: '[]'};
		var _p44 = function () {
			var _p45 = _p43._1.type_;
			switch (_p45.ctor) {
				case 'Info':
					return {
						ctor: '_Tuple2',
					...
					return {
						...
						_1: A2(
							_damienklinnert$elm_spinner$Spinner$view,
							{
								...
								shadow: false,
								hwaccel: false,
								color: _elm_lang$core$Basics$always(
									A4(_elm_lang$core$Color$rgba, 34, 34, 34, 0.8))
							},
							A2(
								_elm_lang$core$Maybe$withDefault,
								_damienklinnert$elm_spinner$Spinner$init,
								A2(_elm_lang$core$Dict$get, _p46, spinner)))
					};
			}
		}();
		var msgClass = _p44._0;
		var iconHtml = _p44._1;
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$List$concat(
				{
				...
				}),
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(_p43._1.message),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: _elm_lang$core$Native_Utils.eq(_p43._1.icon, true) ? iconHtml : A2(
						_elm_lang$html$Html$span,
						{ctor: '[]'},
						{ctor: '[]'}),
					_1: {ctor: '[]'}
...
var _elm_lang$elm_architecture_tutorial$Types$Transactions = {ctor: 'Transactions'};
var _elm_lang$elm_architecture_tutorial$Types$Categories = {ctor: 'Categories'};
var _elm_lang$elm_architecture_tutorial$Types$Accounts = {ctor: 'Accounts'};
...
var _elm_lang$elm_architecture_tutorial$Helper_Core$withIndexes = function () {
	...
	return withIndexesR(0);
}();
var _elm_lang$elm_architecture_tutorial$Helper_Core$lookupWithDefault = F5(
	function (list, getKey, getValue, defaultValue, lookupKey) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			defaultValue,
...
var _elm_lang$elm_architecture_tutorial$Helper_Core$isJust = function (_p4) {
	return !_elm_lang$elm_architecture_tutorial$Helper_Core$isNothing(_p4);
};
var _elm_lang$elm_architecture_tutorial$Helper_Core$roundFloat2dp = function (f) {
	return _elm_lang$core$Basics$toFloat(
		_elm_lang$core$Basics$round(f * 100)) / 100;
};
var _elm_lang$elm_architecture_tutorial$Helper_Core$functionOrDefault = F3(
	function (original, $default, fn) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			$default,
...
var _elm_lang$elm_architecture_tutorial$Transactions_Model$formatFlow = F2(
	function (isInflow, amount) {
		var adjAmount = isInflow ? amount : (0 - amount);
		return (_elm_lang$core$Native_Utils.cmp(adjAmount, 0) < 1) ? '' : A2(_myrho$elm_round$Round$round, 2, adjAmount);
	});
var _elm_lang$elm_architecture_tutorial$Transactions_Model$toEdit = function (row) {
	return {
		storedKey: row.storedKey,
		desc: row.desc,
		inflow: A2(_elm_lang$elm_architecture_tutorial$Transactions_Model$formatFlow, true, row.amount),
		outflow: A2(_elm_lang$elm_architecture_tutorial$Transactions_Model$formatFlow, false, row.amount),
		accountKey: row.accountKey,
		payeeAccountKey: row.payeeAccountKey,
		categoryKey: row.categoryKey,
		date: _elm_lang$core$Maybe$Just(row.date),
		datePicker: _elm_community$elm_datepicker$DatePicker$initFromDate(row.date)
	};
};
var _elm_lang$elm_architecture_tutorial$Transactions_Model$fromEdit = function (editData) {
	var parseFloat = function (str) {
		return _elm_lang$elm_architecture_tutorial$Helper_Core$roundFloat2dp(
			A2(
				_elm_lang$core$Result$withDefault,
				0,
...
var _elm_lang$elm_architecture_tutorial$Transactions_Model$toFromEditable_Transaction = {toEditable: _elm_lang$elm_architecture_tutorial$Transactions_Model$toEdit, toData: _elm_lang$elm_architecture_tutorial$Transactions_Model$fromEdit};
var _elm_lang$elm_architecture_tutorial$Transactions_Model$withLocalId_TransactionPageModel = {
	get: function (_) {
		return _.nextFakeId;
	},
	set: F2(
...
var _elm_lang$elm_architecture_tutorial$Transactions_Model$withStoredKey_EditingTransaction = {
	get: function (_) {
		return _.storedKey;
	},
	set: F2(
...
var _elm_lang$elm_architecture_tutorial$Transactions_Model$EditingTransaction = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {storedKey: a, desc: b, inflow: c, outflow: d, accountKey: e, payeeAccountKey: f, categoryKey: g, date: h, datePicker: i};
	});
var _elm_lang$elm_architecture_tutorial$Transactions_Model$TransactionsPageModel = F5(
	function (a, b, c, d, e) {
		return {editingTransaction: a, confirmDeleteKey: b, nextFakeId: c, selectedAccountKey: d, datePreset: e};
	});
var _elm_lang$elm_architecture_tutorial$Transactions_Model$MonthMinus6 = {ctor: 'MonthMinus6'};
var _elm_lang$elm_architecture_tutorial$Transactions_Model$MonthMinus5 = {ctor: 'MonthMinus5'};
var _elm_lang$elm_architecture_tutorial$Transactions_Model$MonthMinus4 = {ctor: 'MonthMinus4'};
var _elm_lang$elm_architecture_tutorial$Transactions_Model$MonthMinus3 = {ctor: 'MonthMinus3'};
var _elm_lang$elm_architecture_tutorial$Transactions_Model$MonthMinus2 = {ctor: 'MonthMinus2'};
var _elm_lang$elm_architecture_tutorial$Transactions_Model$LastMonth = {ctor: 'LastMonth'};
var _elm_lang$elm_architecture_tutorial$Transactions_Model$ThisMonth = {ctor: 'ThisMonth'};
var _elm_lang$elm_architecture_tutorial$Transactions_Model$All = {ctor: 'All'};

var _elm_lang$elm_architecture_tutorial$Transactions_Message$None = {ctor: 'None'};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$ChooseDateRange = function (a) {
	return {ctor: 'ChooseDateRange', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$ChooseAccount = function (a) {
	return {ctor: 'ChooseAccount', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$StorageFailed = function (a) {
	return {ctor: 'StorageFailed', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$StorageSaveSuccess = F2(
	function (a, b) {
		return {ctor: 'StorageSaveSuccess', _0: a, _1: b};
	});
var _elm_lang$elm_architecture_tutorial$Transactions_Message$StorageDeleteSuccess = {ctor: 'StorageDeleteSuccess'};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$StorageUpdateSuccess = {ctor: 'StorageUpdateSuccess'};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$SetDatePicker = function (a) {
	return {ctor: 'SetDatePicker', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$RejigTransaction = function (a) {
	return {ctor: 'RejigTransaction', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$SetTransactionCategory = function (a) {
	return {ctor: 'SetTransactionCategory', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$SetTransactionPayeeAccount = function (a) {
	return {ctor: 'SetTransactionPayeeAccount', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$SetTransactionDate = function (a) {
	return {ctor: 'SetTransactionDate', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$SetTransactionDesc = function (a) {
	return {ctor: 'SetTransactionDesc', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$SetTransactionOutflow = function (a) {
	return {ctor: 'SetTransactionOutflow', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$SetTransactionInflow = function (a) {
	return {ctor: 'SetTransactionInflow', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$SetEditingTransaction = function (a) {
	return {ctor: 'SetEditingTransaction', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$DoubleClickTransaction = F2(
	function (a, b) {
		return {ctor: 'DoubleClickTransaction', _0: a, _1: b};
	});
var _elm_lang$elm_architecture_tutorial$Transactions_Message$CancelDelete = {ctor: 'CancelDelete'};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$DeleteTransaction = F2(
	function (a, b) {
		return {ctor: 'DeleteTransaction', _0: a, _1: b};
	});
var _elm_lang$elm_architecture_tutorial$Transactions_Message$EditTransaction = function (a) {
	return {ctor: 'EditTransaction', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$CancelTransaction = {ctor: 'CancelTransaction'};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$SaveTransaction = function (a) {
	return {ctor: 'SaveTransaction', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Transactions_Message$AddTransactionWithDate = F2(
	function (a, b) {
		return {ctor: 'AddTransactionWithDate', _0: a, _1: b};
	});
var _elm_lang$elm_architecture_tutorial$Transactions_Message$AddTransaction = function (a) {
	return {ctor: 'AddTransaction', _0: a};
};

var _elm_lang$elm_architecture_tutorial$Categories_Model$toFromEditable_Category = {
	toEditable: function (data) {
		return {storedKey: data.storedKey, name: data.name};
	},
	toData: function (row) {
...
var _elm_lang$elm_architecture_tutorial$Categories_Model$withLocalId_CategoryPageModel = {
	get: function (_) {
		return _.nextFakeId;
	},
	set: F2(
...
var _elm_lang$elm_architecture_tutorial$Categories_Model$withStoredKey_EditingCategoryRow = {
	get: function (_) {
		return _.storedKey;
	},
	set: F2(
...
var _elm_lang$elm_architecture_tutorial$Categories_Model$EditingCategoryRow = F2(
	function (a, b) {
		return {storedKey: a, name: b};
	});
var _elm_lang$elm_architecture_tutorial$Categories_Model$CategoryPageModel = F3(
	function (a, b, c) {
		return {editingCategoryRow: a, confirmDeleteKey: b, nextFakeId: c};
	});

var _elm_lang$elm_architecture_tutorial$Categories_Message$StorageFailed = function (a) {
	return {ctor: 'StorageFailed', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Categories_Message$StorageSaveSuccess = F2(
	function (a, b) {
		return {ctor: 'StorageSaveSuccess', _0: a, _1: b};
	});
var _elm_lang$elm_architecture_tutorial$Categories_Message$StorageDeleteSuccess = {ctor: 'StorageDeleteSuccess'};
var _elm_lang$elm_architecture_tutorial$Categories_Message$StorageUpdateSuccess = {ctor: 'StorageUpdateSuccess'};
var _elm_lang$elm_architecture_tutorial$Categories_Message$SetCategoryName = function (a) {
	return {ctor: 'SetCategoryName', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Categories_Message$DoubleClickCategory = F2(
	function (a, b) {
		return {ctor: 'DoubleClickCategory', _0: a, _1: b};
	});
var _elm_lang$elm_architecture_tutorial$Categories_Message$CancelDelete = {ctor: 'CancelDelete'};
var _elm_lang$elm_architecture_tutorial$Categories_Message$DeleteCategory = F2(
	function (a, b) {
		return {ctor: 'DeleteCategory', _0: a, _1: b};
	});
var _elm_lang$elm_architecture_tutorial$Categories_Message$EditCategory = function (a) {
	return {ctor: 'EditCategory', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Categories_Message$CancelCategory = {ctor: 'CancelCategory'};
var _elm_lang$elm_architecture_tutorial$Categories_Message$SaveCategory = function (a) {
	return {ctor: 'SaveCategory', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Categories_Message$AddCategory = {ctor: 'AddCategory'};

var _elm_lang$elm_architecture_tutorial$Message$SetTodaysDate = function (a) {
	return {ctor: 'SetTodaysDate', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Message$HideLoadingModal = {ctor: 'HideLoadingModal'};
var _elm_lang$elm_architecture_tutorial$Message$ShowPopupMessage = function (a) {
	return {ctor: 'ShowPopupMessage', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Message$HidePopupMessage = {ctor: 'HidePopupMessage'};
var _elm_lang$elm_architecture_tutorial$Message$LostConnection = {ctor: 'LostConnection'};
var _elm_lang$elm_architecture_tutorial$Message$AlertMsg = function (a) {
	return {ctor: 'AlertMsg', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Message$Load = F3(
	function (a, b, c) {
		return {ctor: 'Load', _0: a, _1: b, _2: c};
	});
var _elm_lang$elm_architecture_tutorial$Message$ChoosePage = function (a) {
	return {ctor: 'ChoosePage', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Message$Category = function (a) {
	return {ctor: 'Category', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Message$Account = function (a) {
	return {ctor: 'Account', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Message$Transaction = function (a) {
	return {ctor: 'Transaction', _0: a};
};
var _elm_lang$elm_architecture_tutorial$Message$None = {ctor: 'None'};

var _elm_lang$elm_architecture_tutorial$EditableGrid_Update$updateItemWithKey = F4(
	function (dict, key, newItem, list) {
		return A2(
			_elm_lang$core$List$map,
			function (item) {
				return _elm_lang$core$Native_Utils.eq(
...
var _elm_lang$elm_architecture_tutorial$EditableGrid_Update$setFake = F4(
	function (localIdDic, storedKeyDic, model, record) {
		var localId = localIdDic.get(model);
		return {
			ctor: '_Tuple2',
			_0: A2(localIdDic.set, localId + 1, model),
			_1: A2(
				storedKeyDic.set,
				A2(
					_elm_lang$core$Basics_ops['++'],
					'localid_',
					_elm_lang$core$Basics$toString(localId)),
				record)
		};
	});
var _elm_lang$elm_architecture_tutorial$EditableGrid_Update$applyEditingRow = F5(
	function (sc, identityProvider, persister, editRow, dataRows) {
		var editRowStoredKey = sc.withStoredKeyEditDict.get(editRow);
		if (!_elm_lang$core$Native_Utils.eq(editRowStoredKey, '')) {
			var updatedDataRow = sc.toFromEditableDict.toData(editRow);
			return {
				ctor: '_Tuple3',
				_0: A4(_elm_lang$elm_architecture_tutorial$EditableGrid_Update$updateItemWithKey, sc.withStoredKeyDict, editRowStoredKey, updatedDataRow, dataRows),
				_1: A3(
					_elm_lang$elm_architecture_tutorial$Helper_Task$attempt2,
					sc.toFailMessage,
					_elm_lang$core$Basics$always(sc.updateSuccessMessage),
					A2(persister.update, editRowStoredKey, updatedDataRow)),
				_2: identityProvider
			};
		} else {
			var _p0 = A4(
				_elm_lang$elm_architecture_tutorial$EditableGrid_Update$setFake,
				sc.identityProvider,
				sc.withStoredKeyDict,
				identityProvider,
			...
			return {
				...
				_1: A3(
					_elm_lang$elm_architecture_tutorial$Helper_Task$attempt2,
					sc.toFailMessage,
					sc.toSaveSuccessMessage(
						sc.withStoredKeyDict.get(dataRow)),
					persister.save(dataRow)),
				_2: nextModel
			};
		}
	});
var _elm_lang$elm_architecture_tutorial$EditableGrid_Update$getEditRowFromList = F3(
	function (sc, storedKey, list) {
		return A2(
			_elm_lang$core$Maybe$map,
			sc.toFromEditableDict.toEditable,
			_elm_lang$core$List$head(
				A2(
					_elm_lang$core$List$filter,
					function (item) {
						return _elm_lang$core$Native_Utils.eq(
							sc.withStoredKeyDict.get(item),
							storedKey);
					},
					list)));
	});
var _elm_lang$elm_architecture_tutorial$EditableGrid_Update$EditableRowScheme = F7(
	function (a, b, c, d, e, f, g) {
		return {toFromEditableDict: a, withStoredKeyDict: b, withStoredKeyEditDict: c, identityProvider: d, toFailMessage: e, toSaveSuccessMessage: f, updateSuccessMessage: g};
	});

var _elm_lang$elm_architecture_tutorial$Accounts_Update$txnDependsOnAction = F2(
	function (storedKey, txn) {
		return _elm_lang$core$Native_Utils.eq(txn.accountKey, storedKey) || _elm_lang$core$Native_Utils.eq(txn.payeeAccountKey, storedKey);
	});
var _elm_lang$elm_architecture_tutorial$Accounts_Update$accountDependencies = F2(
	function (txns, storedKey) {
		return A2(
			_elm_lang$core$List$filter,
			_elm_lang$elm_architecture_tutorial$Accounts_Update$txnDependsOnAction(storedKey),
			txns);
	});
var _elm_lang$elm_architecture_tutorial$Accounts_Update$accountHadDependencies = F2(
	function (txns, storedKey) {
		return !_elm_lang$core$List$isEmpty(
			A2(_elm_lang$elm_architecture_tutorial$Accounts_Update$accountDependencies, txns, storedKey));
	});
var _elm_lang$elm_architecture_tutorial$Accounts_Update$dict = {toFromEditableDict: _elm_lang$elm_architecture_tutorial$Accounts_Model$toFromEditable_Account, withStoredKeyDict: _elm_lang$elm_architecture_tutorial$EditableGrid_Interface$withStoredKey_Account, withStoredKeyEditDict: _elm_lang$elm_architecture_tutorial$Accounts_Model$withStoredKey_EditingAccountRow, identityProvider: _elm_lang$elm_architecture_tutorial$Accounts_Model$withLocalId_AccountPageModel, toFailMessage: _elm_lang$elm_architecture_tutorial$Accounts_Message$StorageFailed, toSaveSuccessMessage: _elm_lang$elm_architecture_tutorial$Accounts_Message$StorageSaveSuccess, updateSuccessMessage: _elm_lang$elm_architecture_tutorial$Accounts_Message$StorageUpdateSuccess};
var _elm_lang$elm_architecture_tutorial$Accounts_Update$update = F5(
	function (programData, message, model, accounts, txns) {
		var _p0 = message;
		switch (_p0.ctor) {
			case 'AddAccount':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							editingAccountRow: _elm_lang$core$Maybe$Just(
								{storedKey: '', name: ''})
						}),
					_1: accounts,
					_2: txns,
					_3: _elm_lang$core$Platform_Cmd$none,
					_4: _elm_lang$elm_architecture_tutorial$Message$None
				};
			case 'EditAccount':
				return {
					ctor: '_Tuple5',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							editingAccountRow: A3(_elm_lang$elm_architecture_tutorial$EditableGrid_Update$getEditRowFromList, _elm_lang$elm_architecture_tutorial$Accounts_Update$dict, _p0._0, accounts)
						}),
					_1: accounts,
					_2: txns,
					_3: _elm_lang$core$Platform_Cmd$none,
			...
			case 'SaveAccount':
				var _p1 = A5(_elm_lang$elm_architecture_tutorial$EditableGrid_Update$applyEditingRow, _elm_lang$elm_architecture_tutorial$Accounts_Update$dict, model, programData.accountBaaSPersister, _p0._0, accounts);
				var newAccounts = _p1._0;
				var cmd = _p1._1;
				var nextModel = _p1._2;
				return {
					ctor: '_Tuple5',
					_0: _elm_lang$core$Native_Utils.update(
						nextModel,
						{editingAccountRow: _elm_lang$core$Maybe$Nothing}),
					_1: newAccounts,
					_2: txns,
					_3: cmd,
					_4: _elm_lang$elm_architecture_tutorial$Message$None
			...
			case 'CancelDelete':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{confirmDeleteKey: _elm_lang$core$Maybe$Nothing}),
					_1: accounts,
					_2: txns,
					_3: _elm_lang$core$Platform_Cmd$none,
					_4: _elm_lang$elm_architecture_tutorial$Message$None
			...
			case 'DeleteAccount':
				var _p2 = _p0._0;
				return A2(_elm_lang$elm_architecture_tutorial$Accounts_Update$accountHadDependencies, txns, _p2) ? {
					ctor: '_Tuple5',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{confirmDeleteKey: _elm_lang$core$Maybe$Nothing}),
					...
					_2: txns,
					_3: _elm_lang$core$Platform_Cmd$none,
					_4: _elm_lang$elm_architecture_tutorial$Message$ShowPopupMessage('You cannot delete this account because it has transactions. Delete the transactions first.')
				} : {
					ctor: '_Tuple5',
					_0: _elm_lang$core$Native_Utils.update(
						model,
					...
					_1: A2(
						_elm_lang$core$List$filter,
						function (acc) {
							return !_elm_lang$core$Native_Utils.eq(acc.storedKey, _p2);
						},
						accounts),
					_2: txns,
					_3: A3(
						_elm_lang$elm_architecture_tutorial$Helper_Task$attempt2,
						_elm_lang$elm_architecture_tutorial$Accounts_Message$StorageFailed,
						_elm_lang$core$Basics$always(_elm_lang$elm_architecture_tutorial$Accounts_Message$StorageDeleteSuccess),
						programData.accountBaaSPersister.$delete(_p2)),
					_4: _elm_lang$elm_architecture_tutorial$Message$None
				};
			case 'SetAccountName':
				return {
			...
			case 'StorageSaveSuccess':
				return {
					...
					_1: A2(
						_elm_lang$core$List$map,
						function (account) {
							return _elm_lang$core$Native_Utils.eq(account.storedKey, _p0._0) ? _elm_lang$core$Native_Utils.update(
								account,
								{storedKey: _p0._1}) : account;
						},
						accounts),
					_2: txns,
					_3: _elm_lang$core$Platform_Cmd$none,
			...
			case 'StorageFailed':
				return {ctor: '_Tuple5', _0: model, _1: accounts, _2: txns, _3: _elm_lang$core$Platform_Cmd$none, _4: _elm_lang$elm_architecture_tutorial$Message$LostConnection};
			default:
				return {ctor: '_Tuple5', _0: model, _1: accounts, _2: txns, _3: _elm_lang$core$Platform_Cmd$none, _4: _elm_lang$elm_architecture_tutorial$Message$None};
		}
	});

var _elm_lang$elm_architecture_tutorial$Helper_Html$textHtml = function (t) {
	return A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
...
var _elm_lang$elm_architecture_tutorial$Helper_Html$navi = F5(
	function (className, selectedItem, createMessageForItem, createTextForItem, items) {
		var menuEntry = F2(
			function (item, menuText) {
				...
				if (_p4 === true) {
					return A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('menuitem selected'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(menuText),
							_1: {ctor: '[]'}
						});
				} else {
					return A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('menuitem unselected'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									createMessageForItem(item)),
								_1: {ctor: '[]'}
							}
						},
						{
			...
			A2(
				...
				function (item) {
					return A2(
						menuEntry,
						item,
						createTextForItem(item));
				},
				items));
	});
var _elm_lang$elm_architecture_tutorial$Helper_Html$EditableTableContentScheme = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$elm_architecture_tutorial$Helper_Html$textHtml('&times;'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Deleting this account will delete all of the transactions. Are you sure?'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('confirmation-buttons'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$button,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												A2(_elm_lang$elm_architecture_tutorial$Accounts_Message$DeleteAccount, storedKey, true)),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_elm_lang$elm_architecture_tutorial$Accounts_Message$CancelDelete),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
...
var _elm_lang$elm_architecture_tutorial$Accounts_View$accoutContentScheme = {
	getReadOnlyRowCells: function (acc) {
		return {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: _elm_lang$html$Html$text(acc.name),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class(_elm_lang$elm_architecture_tutorial$Accounts_View$columnIds.name),
					_1: {ctor: '[]'}
				}
			},
			_1: {ctor: '[]'}
	...
	getEditableRowCells: function (row) {
		return {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id(_elm_lang$elm_architecture_tutorial$Accounts_View$columnIds.name),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$type_('text'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$value(row.name),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_elm_lang$elm_architecture_tutorial$Accounts_Message$SetAccountName),
									_1: {ctor: '[]'}
								}
							}
						}
	...
	isCreatingNewRow: function (row) {
		return _elm_lang$core$Native_Utils.eq(row.storedKey, '');
	},
	isRowForEdit: F2(
		function (acc, row) {
			return (!_elm_lang$core$Native_Utils.eq(row.storedKey, '')) && _elm_lang$core$Native_Utils.eq(acc.storedKey, row.storedKey);
		}),
	editMessage: function (acc) {
		return _elm_lang$elm_architecture_tutorial$Accounts_Message$EditAccount(acc.storedKey);
	},
	saveMessage: function (row) {
		return _elm_lang$elm_architecture_tutorial$Accounts_Message$SaveAccount(row);
	},
	cancelMessage: _elm_lang$elm_architecture_tutorial$Accounts_Message$CancelAccount,
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_elm_lang$elm_architecture_tutorial$Accounts_Message$AddAccount),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _elm_lang$elm_architecture_tutorial$Categories_Update$txnDependsOnAction = F2(
	function (catKey, txn) {
		return _elm_lang$core$Native_Utils.eq(txn.categoryKey, catKey);
	});
var _elm_lang$elm_architecture_tutorial$Categories_Update$categoryHadDependencies = F2(
	function (txns, catKey) {
		return A2(
			_elm_lang$core$List$any,
			_elm_lang$elm_architecture_tutorial$Categories_Update$txnDependsOnAction(catKey),
			txns);
	});
var _elm_lang$elm_architecture_tutorial$Categories_Update$dict = {toFromEditableDict: _elm_lang$elm_architecture_tutorial$Categories_Model$toFromEditable_Category, withStoredKeyDict: _elm_lang$elm_architecture_tutorial$EditableGrid_Interface$withStoredKey_Category, withStoredKeyEditDict: _elm_lang$elm_architecture_tutorial$Categories_Model$withStoredKey_EditingCategoryRow, identityProvider: _elm_lang$elm_architecture_tutorial$Categories_Model$withLocalId_CategoryPageModel, toFailMessage: _elm_lang$elm_architecture_tutorial$Categories_Message$StorageFailed, toSaveSuccessMessage: _elm_lang$elm_architecture_tutorial$Categories_Message$StorageSaveSuccess, updateSuccessMessage: _elm_lang$elm_architecture_tutorial$Categories_Message$StorageUpdateSuccess};
var _elm_lang$elm_architecture_tutorial$Categories_Update$update = F5(
	function (programData, message, model, categories, txns) {
		var _p0 = message;
		switch (_p0.ctor) {
			case 'AddCategory':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							editingCategoryRow: _elm_lang$core$Maybe$Just(
								{storedKey: '', name: ''})
						}),
					_1: categories,
					_2: txns,
			...
			case 'EditCategory':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							editingCategoryRow: A3(_elm_lang$elm_architecture_tutorial$EditableGrid_Update$getEditRowFromList, _elm_lang$elm_architecture_tutorial$Categories_Update$dict, _p0._0, categories)
						}),
					_1: categories,
					_2: txns,
					_3: _elm_lang$core$Platform_Cmd$none,
			...
			case 'SaveCategory':
				var _p1 = A5(_elm_lang$elm_architecture_tutorial$EditableGrid_Update$applyEditingRow, _elm_lang$elm_architecture_tutorial$Categories_Update$dict, model, programData.categoryBaaSPersister, _p0._0, categories);
				var newCategories = _p1._0;
				var cmd = _p1._1;
				var nextModel = _p1._2;
				return {
					ctor: '_Tuple5',
					_0: _elm_lang$core$Native_Utils.update(
						nextModel,
						{editingCategoryRow: _elm_lang$core$Maybe$Nothing}),
					_1: newCategories,
					_2: txns,
					_3: cmd,
					_4: _elm_lang$elm_architecture_tutorial$Message$None
			...
			case 'DeleteCategory':
				var _p2 = _p0._0;
				return A2(_elm_lang$elm_architecture_tutorial$Categories_Update$categoryHadDependencies, txns, _p2) ? {
					ctor: '_Tuple5',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{confirmDeleteKey: _elm_lang$core$Maybe$Nothing}),
					...
					_2: txns,
					_3: _elm_lang$core$Platform_Cmd$none,
					_4: _elm_lang$elm_architecture_tutorial$Message$ShowPopupMessage('You cannot delete this category because it is used in transactions. Delete the transactions first.')
				} : {
					ctor: '_Tuple5',
					_0: _elm_lang$core$Native_Utils.update(
						model,
					...
					_2: A2(
						_elm_lang$core$List$filter,
						function (txn) {
							return !A2(_elm_lang$elm_architecture_tutorial$Categories_Update$txnDependsOnAction, _p2, txn);
						},
						txns),
					_3: A3(
						_elm_lang$elm_architecture_tutorial$Helper_Task$attempt2,
						_elm_lang$elm_architecture_tutorial$Categories_Message$StorageFailed,
						_elm_lang$core$Basics$always(_elm_lang$elm_architecture_tutorial$Categories_Message$StorageDeleteSuccess),
						programData.categoryBaaSPersister.$delete(_p2)),
					_4: _elm_lang$elm_architecture_tutorial$Message$None
				};
			...
			case 'StorageSaveSuccess':
				return {
					...
					_1: A2(
						_elm_lang$core$List$map,
						function (category) {
							return _elm_lang$core$Native_Utils.eq(category.storedKey, _p0._0) ? _elm_lang$core$Native_Utils.update(
								category,
								{storedKey: _p0._1}) : category;
						},
						categories),
					_2: txns,
					_3: _elm_lang$core$Platform_Cmd$none,
			...
			case 'StorageFailed':
				return {ctor: '_Tuple5', _0: model, _1: categories, _2: txns, _3: _elm_lang$core$Platform_Cmd$none, _4: _elm_lang$elm_architecture_tutorial$Message$LostConnection};
			default:
				return {ctor: '_Tuple5', _0: model, _1: categories, _2: txns, _3: _elm_lang$core$Platform_Cmd$none, _4: _elm_lang$elm_architecture_tutorial$Message$None};
		}
	});

var _elm_lang$elm_architecture_tutorial$Categories_View$columnIds = {name: 'CategoryName'};
var _elm_lang$elm_architecture_tutorial$Categories_View$deleteModal = function (key) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Deleting this category will delete all of the transactions. Are you sure?'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												A2(_elm_lang$elm_architecture_tutorial$Categories_Message$DeleteCategory, key, true)),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_elm_lang$elm_architecture_tutorial$Categories_Message$CancelDelete),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
...
var _elm_lang$elm_architecture_tutorial$Categories_View$contentScheme = {
	getReadOnlyRowCells: function (acc) {
		return {
			ctor: '::',
			_0: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class(_elm_lang$elm_architecture_tutorial$Categories_View$columnIds.name),
					_1: {ctor: '[]'}
				}
			},
			_1: {ctor: '[]'}
		...
		return {
			...
			_0: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id(_elm_lang$elm_architecture_tutorial$Categories_View$columnIds.name),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$type_('text'),
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_elm_lang$elm_architecture_tutorial$Categories_Message$SetCategoryName),
									_1: {ctor: '[]'}
								}
							}
						}
	...
	editMessage: function (acc) {
		return _elm_lang$elm_architecture_tutorial$Categories_Message$EditCategory(acc.storedKey);
	},
	saveMessage: function (row) {
		return _elm_lang$elm_architecture_tutorial$Categories_Message$SaveCategory(row);
	},
	cancelMessage: _elm_lang$elm_architecture_tutorial$Categories_Message$CancelCategory,
	deleteMessage: function (acc) {
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_elm_lang$elm_architecture_tutorial$Categories_Message$AddCategory),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _elm_lang$elm_architecture_tutorial$DatePicker_Settings$settings = _elm_lang$core$Native_Utils.update(
	_elm_community$elm_datepicker$DatePicker$defaultSettings,
	{
		...
		inputId: _elm_lang$core$Maybe$Just('datepicker')
	});

var _elm_lang$elm_architecture_tutorial$Model$hasLoaded = function (model) {
	var w = model.whatsLoaded;
	return w.accounts && (w.categories && w.transactions);
};
var _elm_lang$elm_architecture_tutorial$Model$empty = {
	txns: {ctor: '[]'},
	accounts: {ctor: '[]'},
	categories: {ctor: '[]'},
	page: _elm_lang$elm_architecture_tutorial$Types$Accounts,
	accountPageModel: {editingAccountRow: _elm_lang$core$Maybe$Nothing, confirmDeleteKey: _elm_lang$core$Maybe$Nothing, nextFakeId: 0},
	categoryPageModel: {editingCategoryRow: _elm_lang$core$Maybe$Nothing, confirmDeleteKey: _elm_lang$core$Maybe$Nothing, nextFakeId: 0},
	transactionsPageModel: {editingTransaction: _elm_lang$core$Maybe$Nothing, confirmDeleteKey: _elm_lang$core$Maybe$Nothing, nextFakeId: 0, selectedAccountKey: '', datePreset: _elm_lang$elm_architecture_tutorial$Transactions_Model$All},
	alerts: _wittjosiah$elm_alerts$Alert$initModel(true),
	lostConnection: false,
	popupMessage: _elm_lang$core$Maybe$Nothing,
								...
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return {txns: a, accounts: b, categories: c, page: d, accountPageModel: e, categoryPageModel: f, transactionsPageModel: g, alerts: h, lostConnection: i, popupMessage: j, whatsLoaded: k, showLoadingModal: l, today: m};
												};
											};
										};
									};
...
var _elm_lang$elm_architecture_tutorial$Model$WhatsLoaded = F3(
	function (a, b, c) {
		return {accounts: a, categories: b, transactions: c};
	});
...
var _elm_lang$elm_architecture_tutorial$Transactions_Common$lastDayOfMonth = function (d) {
	var firstDayOfNextMonth = A2(
		_elm_lang$core$Maybe$withDefault,
		d,
		A2(
	...
	return A3(_rluiten$elm_date_extra$Date_Extra_Duration$add, _rluiten$elm_date_extra$Date_Extra_Duration$Day, -1, firstDayOfNextMonth);
};
var _elm_lang$elm_architecture_tutorial$Transactions_Common$firstDayOfMonth = function (d) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		d,
		A2(
...
var _elm_lang$elm_architecture_tutorial$Transactions_Common$isDateInRange = F2(
	function (range, date) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			true,
			A2(
				_elm_lang$core$Maybe$map,
				function (from) {
					return A3(_rluiten$elm_date_extra$Date_Extra_Compare$is, _rluiten$elm_date_extra$Date_Extra_Compare$Before, from, date);
				},
				range.from)) && A2(
			_elm_lang$core$Maybe$withDefault,
			true,
			A2(
				_elm_lang$core$Maybe$map,
				function (to) {
					return A3(_rluiten$elm_date_extra$Date_Extra_Compare$is, _rluiten$elm_date_extra$Date_Extra_Compare$Before, date, to);
				},
				range.to));
	});
var _elm_lang$elm_architecture_tutorial$Transactions_Common$unbounded = {from: _elm_lang$core$Maybe$Nothing, to: _elm_lang$core$Maybe$Nothing};
var _elm_lang$elm_architecture_tutorial$Transactions_Common$definiteRange = F2(
	function (f, t) {
		return {
			from: _elm_lang$core$Maybe$Just(f),
			to: _elm_lang$core$Maybe$Just(t)
		};
	});
var _elm_lang$elm_architecture_tutorial$Transactions_Common$datePresets = function (today) {
	var oneMonthAgo = A3(_rluiten$elm_date_extra$Date_Extra_Duration$add, _rluiten$elm_date_extra$Date_Extra_Duration$Month, -1, today);
	return {
		ctor: '::',
		_0: {key: 'all', presetType: _elm_lang$elm_architecture_tutorial$Transactions_Model$All, text: 'All', range: _elm_lang$elm_architecture_tutorial$Transactions_Common$unbounded},
		_1: {
			ctor: '::',
			_0: {
				key: 'thismonth',
				presetType: _elm_lang$elm_architecture_tutorial$Transactions_Model$ThisMonth,
				text: A3(_rluiten$elm_date_extra$Date_Extra_Format$format, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_au$config, '%B %y', today),
				range: A2(
					_elm_lang$elm_architecture_tutorial$Transactions_Common$definiteRange,
					_elm_lang$elm_architecture_tutorial$Transactions_Common$firstDayOfMonth(today),
					_elm_lang$elm_architecture_tutorial$Transactions_Common$lastDayOfMonth(today))
			},
			_1: {
				ctor: '::',
				_0: {
					key: 'lastmonth',
					presetType: _elm_lang$elm_architecture_tutorial$Transactions_Model$LastMonth,
					text: A3(_rluiten$elm_date_extra$Date_Extra_Format$format, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_au$config, '%B %y', oneMonthAgo),
					range: A2(
						_elm_lang$elm_architecture_tutorial$Transactions_Common$definiteRange,
						_elm_lang$elm_architecture_tutorial$Transactions_Common$firstDayOfMonth(oneMonthAgo),
						_elm_lang$elm_architecture_tutorial$Transactions_Common$lastDayOfMonth(oneMonthAgo))
				},
				_1: {ctor: '[]'}
			}
		}
...
var _elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds = {description: 'description', date: 'date', payee: 'payee', category: 'category', inflow: 'inflow', outflow: 'outflow', balance: 'balance'};
var _elm_lang$elm_architecture_tutorial$Transactions_Common$ValidationResult = function (a) {
	return {dateInvalid: a};
};
var _elm_lang$elm_architecture_tutorial$Transactions_Common$DateRange = F2(
	function (a, b) {
		return {from: a, to: b};
	});
var _elm_lang$elm_architecture_tutorial$Transactions_Common$DatePresetDict = F4(
	function (a, b, c, d) {
		return {key: a, presetType: b, text: c, range: d};
	});

var _elm_lang$elm_architecture_tutorial$Transactions_Update$focus = function (id) {
	return A2(
		_elm_lang$core$Task$attempt,
		function (_p0) {
			return _elm_lang$elm_architecture_tutorial$Transactions_Message$None;
		},
		A2(
			_elm_lang$core$Task$map,
			function (_p1) {
...
var _elm_lang$elm_architecture_tutorial$Transactions_Update$dict = {toFromEditableDict: _elm_lang$elm_architecture_tutorial$Transactions_Model$toFromEditable_Transaction, withStoredKeyDict: _elm_lang$elm_architecture_tutorial$EditableGrid_Interface$withStoredKey_Transaction, withStoredKeyEditDict: _elm_lang$elm_architecture_tutorial$Transactions_Model$withStoredKey_EditingTransaction, identityProvider: _elm_lang$elm_architecture_tutorial$Transactions_Model$withLocalId_TransactionPageModel, toFailMessage: _elm_lang$elm_architecture_tutorial$Transactions_Message$StorageFailed, toSaveSuccessMessage: _elm_lang$elm_architecture_tutorial$Transactions_Message$StorageSaveSuccess, updateSuccessMessage: _elm_lang$elm_architecture_tutorial$Transactions_Message$StorageUpdateSuccess};
var _elm_lang$elm_architecture_tutorial$Transactions_Update$update = F5(
	function (today, programData, msg, model, txns) {
		var editTransaction = function (storedKey) {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					editingTransaction: A3(_elm_lang$elm_architecture_tutorial$EditableGrid_Update$getEditRowFromList, _elm_lang$elm_architecture_tutorial$Transactions_Update$dict, storedKey, txns)
				});
		};
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'AddTransaction':
				return {
					...
					_2: A2(
						_elm_lang$core$Task$perform,
						_elm_lang$elm_architecture_tutorial$Transactions_Message$AddTransactionWithDate(_p2._0),
						_elm_lang$core$Date$now),
					_3: _elm_lang$elm_architecture_tutorial$Message$None
				};
			case 'AddTransactionWithDate':
				var newTxn = {storedKey: '', desc: '', amount: 0, accountKey: _p2._0, payeeAccountKey: '', categoryKey: '', date: _p2._1};
				return {
					ctor: '_Tuple4',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							editingTransaction: _elm_lang$core$Maybe$Just(
								_elm_lang$elm_architecture_tutorial$Transactions_Model$toEdit(newTxn))
						}),
					_1: txns,
					_2: _elm_lang$elm_architecture_tutorial$Transactions_Update$focus(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.description),
					_3: _elm_lang$elm_architecture_tutorial$Message$None
				};
			case 'EditTransaction':
				return {
					ctor: '_Tuple4',
					_0: editTransaction(_p2._0),
					_1: txns,
			...
			case 'DeleteTransaction':
				...
				return _p2._1 ? {
					...
					_1: A2(
						_elm_lang$core$List$filter,
						function (txn) {
							return !_elm_lang$core$Native_Utils.eq(txn.storedKey, _p3);
						},
						txns),
					_2: A3(
						_elm_lang$elm_architecture_tutorial$Helper_Task$attempt2,
						_elm_lang$elm_architecture_tutorial$Transactions_Message$StorageFailed,
						_elm_lang$core$Basics$always(_elm_lang$elm_architecture_tutorial$Transactions_Message$StorageDeleteSuccess),
						programData.transactionBaaSPersister.$delete(_p3)),
					_3: _elm_lang$elm_architecture_tutorial$Message$None
				} : {
					ctor: '_Tuple4',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							confirmDeleteKey: _elm_lang$core$Maybe$Just(_p3)
						}),
					_1: txns,
					_2: _elm_lang$core$Platform_Cmd$none,
					_3: _elm_lang$elm_architecture_tutorial$Message$None
			...
			case 'DoubleClickTransaction':
				return {
					ctor: '_Tuple4',
					_0: editTransaction(_p2._0),
					_1: txns,
					_2: _elm_lang$elm_architecture_tutorial$Transactions_Update$focus(_p2._1),
					_3: _elm_lang$elm_architecture_tutorial$Message$None
				};
			case 'SaveTransaction':
				var _p4 = A5(_elm_lang$elm_architecture_tutorial$EditableGrid_Update$applyEditingRow, _elm_lang$elm_architecture_tutorial$Transactions_Update$dict, model, programData.transactionBaaSPersister, _p2._0, txns);
				var newTransactions = _p4._0;
				var cmd = _p4._1;
				var nextModel = _p4._2;
				return {
					ctor: '_Tuple4',
					_0: _elm_lang$core$Native_Utils.update(
						nextModel,
						{editingTransaction: _elm_lang$core$Maybe$Nothing}),
					_1: newTransactions,
					_2: cmd,
					_3: _elm_lang$elm_architecture_tutorial$Message$None
				};
			...
			case 'SetEditingTransaction':
				return {
					ctor: '_Tuple4',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							editingTransaction: _elm_lang$core$Maybe$Just(_p2._0)
						}),
					_1: txns,
					_2: _elm_lang$core$Platform_Cmd$none,
					_3: _elm_lang$elm_architecture_tutorial$Message$None
				};
			case 'RejigTransaction':
				return {
					ctor: '_Tuple4',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							editingTransaction: _elm_lang$core$Maybe$Just(
								_elm_lang$elm_architecture_tutorial$Transactions_Model$toEdit(
									_elm_lang$elm_architecture_tutorial$Transactions_Model$fromEdit(_p2._0)))
						}),
					_1: txns,
					_2: _elm_lang$core$Platform_Cmd$none,
					_3: _elm_lang$elm_architecture_tutorial$Message$None
			...
			case 'SetDatePicker':
				return A2(
					_elm_lang$core$Maybe$withDefault,
					{ctor: '_Tuple4', _0: model, _1: txns, _2: _elm_lang$core$Platform_Cmd$none, _3: _elm_lang$elm_architecture_tutorial$Message$None},
					A2(
						_elm_lang$core$Maybe$map,
						function (editingTransaction) {
							var _p5 = A3(_elm_community$elm_datepicker$DatePicker$update, _elm_lang$elm_architecture_tutorial$DatePicker_Settings$settings, _p2._0, editingTransaction.datePicker);
							...
							var newEditingTransaction = _elm_lang$core$Maybe$Just(
								_elm_lang$core$Native_Utils.update(
									editingTransaction,
							...
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{editingTransaction: newEditingTransaction}),
								_1: txns,
								_2: A2(_elm_lang$core$Platform_Cmd$map, _elm_lang$elm_architecture_tutorial$Transactions_Message$SetDatePicker, datePickerCmd),
								_3: _elm_lang$elm_architecture_tutorial$Message$None
							};
						},
						model.editingTransaction));
			case 'StorageFailed':
				return {ctor: '_Tuple4', _0: model, _1: txns, _2: _elm_lang$core$Platform_Cmd$none, _3: _elm_lang$elm_architecture_tutorial$Message$LostConnection};
			case 'ChooseAccount':
				return {
					ctor: '_Tuple4',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{selectedAccountKey: _p2._0}),
					_1: txns,
					_2: _elm_lang$core$Platform_Cmd$none,
					_3: _elm_lang$elm_architecture_tutorial$Message$None
				};
			case 'ChooseDateRange':
				var newDatePreset = A2(
					_elm_lang$core$Maybe$withDefault,
					_elm_lang$elm_architecture_tutorial$Transactions_Model$All,
					A2(
						_elm_lang$core$Maybe$map,
						function (p) {
							return p.presetType;
						...
						_elm_lang$core$List$head(
							A2(
								_elm_lang$core$List$filter,
								function (p) {
									return _elm_lang$core$Native_Utils.eq(p.key, _p2._0);
								},
								_elm_lang$elm_architecture_tutorial$Transactions_Common$datePresets(today)))));
				return {
					ctor: '_Tuple4',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			default:
				return {ctor: '_Tuple4', _0: model, _1: txns, _2: _elm_lang$core$Platform_Cmd$none, _3: _elm_lang$elm_architecture_tutorial$Message$None};
		}
	});
	...
	function (programData, msg, model) {
		...
		switch (_p0.ctor) {
			case 'None':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Transaction':
				var _p1 = A5(_elm_lang$elm_architecture_tutorial$Transactions_Update$update, model.today, programData, _p0._0, model.transactionsPageModel, model.txns);
				var newTransactionsPageModel = _p1._0;
				var newTxns = _p1._1;
				var txnCmd = _p1._2;
				var topMsg = _p1._3;
				return A3(
					_ccapndave$elm_update_extra$Update_Extra$andThen,
					_elm_lang$elm_architecture_tutorial$Update$update(programData),
					topMsg,
					{
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{transactionsPageModel: newTransactionsPageModel, txns: newTxns}),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _elm_lang$elm_architecture_tutorial$Message$Transaction, txnCmd)
					});
			case 'Account':
				var _p2 = A5(_elm_lang$elm_architecture_tutorial$Accounts_Update$update, programData, _p0._0, model.accountPageModel, model.accounts, model.txns);
				var newAccountPageModel = _p2._0;
				var newAccounts = _p2._1;
				var newTxns = _p2._2;
				var accCmd = _p2._3;
				var topMsg = _p2._4;
				return A3(
					...
					topMsg,
					{
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{accountPageModel: newAccountPageModel, accounts: newAccounts, txns: newTxns}),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _elm_lang$elm_architecture_tutorial$Message$Account, accCmd)
					});
			case 'Category':
				var _p3 = A5(_elm_lang$elm_architecture_tutorial$Categories_Update$update, programData, _p0._0, model.categoryPageModel, model.categories, model.txns);
				var newCategoryPageModel = _p3._0;
				var newCategories = _p3._1;
				var newTxns = _p3._2;
				var catCmd = _p3._3;
				var topMsg = _p3._4;
				return A3(
					...
					topMsg,
					{
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{categoryPageModel: newCategoryPageModel, categories: newCategories, txns: newTxns}),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _elm_lang$elm_architecture_tutorial$Message$Category, catCmd)
					});
			case 'ChoosePage':
				return {
					ctor: '_Tuple2',
			...
			case 'Load':
				...
				var _p5 = _p0._1;
				var _p4 = _p0._0;
				var whatsLoaded = model.whatsLoaded;
				var transactions = A2(_elm_lang$core$Maybe$withDefault, model.txns, _p6);
				var categories = A2(_elm_lang$core$Maybe$withDefault, model.categories, _p5);
				var accounts = A2(_elm_lang$core$Maybe$withDefault, model.accounts, _p4);
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						txns: transactions,
						whatsLoaded: _elm_lang$core$Native_Utils.update(
							whatsLoaded,
							{
								accounts: whatsLoaded.accounts || _elm_lang$elm_architecture_tutorial$Helper_Core$isJust(_p4),
								categories: whatsLoaded.categories || _elm_lang$elm_architecture_tutorial$Helper_Core$isJust(_p5),
								transactions: whatsLoaded.transactions || _elm_lang$elm_architecture_tutorial$Helper_Core$isJust(_p6)
							})
					});
				return {
					ctor: '_Tuple2',
					_0: newModel,
					_1: _elm_lang$elm_architecture_tutorial$Model$hasLoaded(newModel) ? A2(_elm_lang$elm_architecture_tutorial$Helper_Core$delay, 2 * _elm_lang$core$Time$second, _elm_lang$elm_architecture_tutorial$Message$HideLoadingModal) : _elm_lang$core$Platform_Cmd$none
				};
			case 'AlertMsg':
				var _p7 = A2(_wittjosiah$elm_alerts$Alert$update, _p0._0, model.alerts);
				var alerts = _p7._0;
				var cmd = _p7._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{alerts: alerts}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _elm_lang$elm_architecture_tutorial$Message$AlertMsg, cmd)
				};
			case 'LostConnection':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{lostConnection: true, showLoadingModal: false}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'HidePopupMessage':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'ShowPopupMessage':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							popupMessage: _elm_lang$core$Maybe$Just(_p0._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
...
var _elm_lang$elm_architecture_tutorial$Transactions_View$accountKeyIsValid = F2(
	function (accs, key) {
		return _elm_lang$core$Native_Utils.eq(key, '') ? false : A2(
			_elm_lang$core$List$any,
			function (acc) {
				return _elm_lang$core$Native_Utils.eq(acc.storedKey, key);
			},
			accs);
	});
var _elm_lang$elm_architecture_tutorial$Transactions_View$deleteModal = function (key) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Delete Transaction. Are you sure?'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												A2(_elm_lang$elm_architecture_tutorial$Transactions_Message$DeleteTransaction, key, true)),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_elm_lang$elm_architecture_tutorial$Transactions_Message$CancelDelete),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
...
var _elm_lang$elm_architecture_tutorial$Transactions_View$toTransaction = function (t) {
	return {storedKey: t.storedKey, desc: t.desc, amount: t.amount, accountKey: t.accountKey, payeeAccountKey: t.payeeAccountKey, categoryKey: t.categoryKey, date: t.date};
};
var _elm_lang$elm_architecture_tutorial$Transactions_View$makeContentScheme = F2(
	function (accounts, categories) {
		return {
			getReadOnlyRowCells: function (txn) {
				var wrapHandler = F2(
					function (elemId, str) {
						return A2(
							_elm_lang$html$Html$div,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('textwrap'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$title(str),
									_1: {ctor: '[]'}
								}
							},
							{
				...
				var erow = _elm_lang$elm_architecture_tutorial$Transactions_Model$toEdit(
					_elm_lang$elm_architecture_tutorial$Transactions_View$toTransaction(txn));
				var doubleClickHandler = function (elemId) {
					return _elm_lang$html$Html_Events$onDoubleClick(
						A2(_elm_lang$elm_architecture_tutorial$Transactions_Message$DoubleClickTransaction, erow.storedKey, elemId));
				};
				var elems = function (elemId) {
					return {
						ctor: '::',
						_0: doubleClickHandler(elemId),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(elemId),
							_1: {ctor: '[]'}
						}
					};
				};
				return {
					...
					_0: {
						ctor: '_Tuple2',
						_0: A2(wrapHandler, _elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.description, erow.desc),
						_1: elems(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.description)
					},
					_1: {
						ctor: '::',
						_0: {
							...
							_0: A2(
								wrapHandler,
								_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.date,
								A2(
									_elm_lang$core$Maybe$withDefault,
									'',
									A2(
										_elm_lang$core$Maybe$map,
										A2(_rluiten$elm_date_extra$Date_Extra_Format$format, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_au$config, '%Y-%m-%d'),
										erow.date))),
							_1: elems(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.date)
						},
						_1: {
							ctor: '::',
							_0: {
								...
								_0: A2(
									wrapHandler,
									_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.payee,
									A5(
										_elm_lang$elm_architecture_tutorial$Helper_Core$lookupWithDefault,
										accounts,
										function (acc) {
											return acc.storedKey;
										},
										function (acc) {
											return acc.name;
										},
										'',
										erow.payeeAccountKey)),
								_1: elems(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.payee)
							},
							_1: {
								ctor: '::',
								_0: {
									...
									_0: A2(
										wrapHandler,
										_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.category,
										A5(
											_elm_lang$elm_architecture_tutorial$Helper_Core$lookupWithDefault,
											categories,
											function (cat) {
												return cat.storedKey;
											},
											function (cat) {
												return cat.name;
											},
											'',
											erow.categoryKey)),
									_1: elems(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.category)
								},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
										_0: A2(wrapHandler, _elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.inflow, erow.inflow),
										_1: elems(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.inflow)
									},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: A2(wrapHandler, _elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.outflow, erow.outflow),
											_1: elems(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.outflow)
										},
										_1: {
											ctor: '::',
											_0: {
												ctor: '_Tuple2',
												_0: _elm_lang$html$Html$text(
													A2(_myrho$elm_round$Round$round, 2, txn.balance)),
												_1: elems(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.balance)
											},
											_1: {ctor: '[]'}
										}
									}
			...
			getEditableRowCells: function (row) {
				var unchosenCategory = {storedKey: '', name: ''};
				var unchosenAccount = {storedKey: '', name: ''};
				return {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$id(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.description),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.description),
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(row.desc),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(
														function (text) {
															return _elm_lang$elm_architecture_tutorial$Transactions_Message$SetEditingTransaction(
																_elm_lang$core$Native_Utils.update(
																	row,
																	{desc: text}));
														}),
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.description),
							_1: {ctor: '[]'}
						}
					},
					_1: {
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										_elm_lang$elm_architecture_tutorial$Transactions_Message$SetDatePicker,
										A3(_elm_community$elm_datepicker$DatePicker$view, row.date, _elm_lang$elm_architecture_tutorial$DatePicker_Settings$settings, row.datePicker)),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.date),
								_1: {ctor: '[]'}
							}
						},
						_1: {
							...
							_0: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$id(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.payee),
										_1: {
											ctor: '::',
											_0: _elm_lang$elm_architecture_tutorial$Helper_Html$onChange(
												function (text) {
													return _elm_lang$elm_architecture_tutorial$Transactions_Message$SetEditingTransaction(
														_elm_lang$core$Native_Utils.update(
															row,
															{payeeAccountKey: text}));
												}),
											_1: {ctor: '[]'}
										}
									},
									A2(
										...
										function (acc) {
											return A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value(acc.storedKey),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$selected(
															_elm_lang$core$Native_Utils.eq(acc.storedKey, row.payeeAccountKey)),
														_1: {ctor: '[]'}
													}
												},
												{
										...
										{ctor: '::', _0: unchosenAccount, _1: accounts})),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.payee),
									_1: {ctor: '[]'}
								}
							},
							_1: {
								...
								_0: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$id(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.category),
											_1: {
												ctor: '::',
												_0: _elm_lang$elm_architecture_tutorial$Helper_Html$onChange(
													function (text) {
										...
										A2(
											...
											function (cat) {
												return A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$value(cat.storedKey),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$selected(
																_elm_lang$core$Native_Utils.eq(cat.storedKey, row.categoryKey)),
															_1: {ctor: '[]'}
														}
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(cat.name),
														_1: {ctor: '[]'}
													});
											},
											{ctor: '::', _0: unchosenCategory, _1: categories})),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.category),
										_1: {ctor: '[]'}
									}
								},
								_1: {
									...
									_0: {
											...
											_elm_lang$html$Html$input,
											{
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$value(row.inflow),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onInput(
																	function (text) {
																...
																_1: {
																	...
																	_0: _elm_lang$html$Html_Events$onBlur(
																		_elm_lang$elm_architecture_tutorial$Transactions_Message$RejigTransaction(row)),
																	_1: {ctor: '[]'}
																}
															}
														}
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.inflow),
											_1: {ctor: '[]'}
										}
									},
									_1: {
										...
										_0: {
												...
												_elm_lang$html$Html$input,
												{
													...
													_1: {
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$value(row.outflow),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onInput(
																		function (text) {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.outflow),
												_1: {ctor: '[]'}
											}
										},
										_1: {
											...
											_0: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class(_elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.balance),
													_1: {ctor: '[]'}
												}
											},
											_1: {ctor: '[]'}
			...
			editMessage: function (acc) {
				return A2(_elm_lang$elm_architecture_tutorial$Transactions_Message$DoubleClickTransaction, acc.storedKey, _elm_lang$elm_architecture_tutorial$Transactions_Common$columnIds.description);
			},
			saveMessage: function (row) {
				return _elm_lang$elm_architecture_tutorial$Transactions_Message$SaveTransaction(row);
			},
			cancelMessage: _elm_lang$elm_architecture_tutorial$Transactions_Message$CancelTransaction,
			deleteMessage: function (acc) {
...
var _elm_lang$elm_architecture_tutorial$Transactions_View$toTransactionView = function (t) {
	return {storedKey: t.storedKey, desc: t.desc, amount: t.amount, accountKey: t.accountKey, payeeAccountKey: t.payeeAccountKey, categoryKey: t.categoryKey, date: t.date, balance: 0};
};
var _elm_lang$elm_architecture_tutorial$Transactions_View$toTransactionViews = F3(
	function (range, txns, accountKey) {
		var txnsForAccount = A2(
			_elm_lang$core$List$sortBy,
			function (txn) {
				return {
					ctor: '_Tuple2',
					_0: A3(_rluiten$elm_date_extra$Date_Extra_Format$format, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_au$config, '%Y-%m-%d', txn.date),
					_1: txn.storedKey
				};
			},
			A2(
				_elm_lang$core$List$filter,
				function (txn) {
					return _elm_lang$core$Native_Utils.eq(txn.accountKey, accountKey);
				},
				txns));
		var balances = A2(
		...
		return A2(
			_elm_lang$core$List$filter,
			function (txn) {
				return A2(_elm_lang$elm_architecture_tutorial$Transactions_Common$isDateInRange, range, txn.date);
			},
			A3(
				_elm_lang$core$List$map2,
				F2(
					function (txn, bal) {
						var view = _elm_lang$elm_architecture_tutorial$Transactions_View$toTransactionView(txn);
						return _elm_lang$core$Native_Utils.update(
							view,
							{balance: bal});
					}),
...
var _elm_lang$elm_architecture_tutorial$Transactions_View$view = F5(
	function (today, accounts, categories, txns, model) {
		var range = A2(
			_elm_lang$core$Maybe$withDefault,
			_elm_lang$elm_architecture_tutorial$Transactions_Common$unbounded,
			A2(
				_elm_lang$core$Maybe$map,
				function (p) {
					return p.range;
				...
				_elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filter,
						function (p) {
							return _elm_lang$core$Native_Utils.eq(model.datePreset, p.presetType);
						},
						_elm_lang$elm_architecture_tutorial$Transactions_Common$datePresets(today)))));
		var skeletonC12 = function (content) {
			return A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
		...
		var skeletonC6 = function (content) {
			return A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
		...
		var skeletonC4 = function (content) {
			return A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('four columns'),
					_1: {ctor: '[]'}
				},
				content);
		};
		var skeletonRow = function (content) {
			return A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
				...
				_0: skeletonC4(
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$for('accountchooser'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Select Account'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id('accountchooser'),
									_1: {
										ctor: '::',
										_0: _elm_lang$elm_architecture_tutorial$Helper_Html$onChange(_elm_lang$elm_architecture_tutorial$Transactions_Message$ChooseAccount),
										_1: {ctor: '[]'}
									}
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Please Select ...'),
											_1: {ctor: '[]'}
										}),
									_1: A2(
										_elm_lang$core$List$map,
											...
											return A2(
												_elm_lang$html$Html$option,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$selected(
															_elm_lang$core$Native_Utils.eq(acc.storedKey, model.selectedAccountKey)),
														_1: {ctor: '[]'}
													}
												},
												{
					...
					_0: skeletonC4(
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$for('daterangechooser'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(' Date Range'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$id('daterangechooser'),
										_1: {
											ctor: '::',
											_0: _elm_lang$elm_architecture_tutorial$Helper_Html$onChange(_elm_lang$elm_architecture_tutorial$Transactions_Message$ChooseDateRange),
											_1: {ctor: '[]'}
										}
									},
									A2(
										...
										function (preset) {
											return A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value(preset.key),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$selected(
															_elm_lang$core$Native_Utils.eq(model.datePreset, preset.presetType)),
														_1: {ctor: '[]'}
													}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(preset.text),
													_1: {ctor: '[]'}
												});
										},
										_elm_lang$elm_architecture_tutorial$Transactions_Common$datePresets(today))),
		...
		var contentScheme = A2(_elm_lang$elm_architecture_tutorial$Transactions_View$makeContentScheme, accounts, categories);
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			_elm_lang$core$List$isEmpty(accounts) ? {
				ctor: '::',
				_0: skeletonRow(
					{
						ctor: '::',
						_0: skeletonC12(
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Please add an account first, then you can add transactions'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
				...
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$elm_architecture_tutorial$Transactions_View$accountKeyIsValid, accounts, model.selectedAccountKey) ? skeletonRow(
						{
							ctor: '::',
							_0: skeletonC12(
								{
					...
					_1: {
						...
						_0: function () {
							...
							if (_p0.ctor === 'Nothing') {
								...
								return _elm_lang$elm_architecture_tutorial$Transactions_View$deleteModal(_p0._0);
							}
						}(),
						_1: {ctor: '[]'}
					}
...
var _elm_lang$elm_architecture_tutorial$Transactions_View$TransactionView = F8(
	function (a, b, c, d, e, f, g, h) {
		return {storedKey: a, desc: b, amount: c, accountKey: d, payeeAccountKey: e, categoryKey: f, date: g, balance: h};
	});

var _elm_lang$elm_architecture_tutorial$View$popupMessageModal = function (message) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_elm_lang$elm_architecture_tutorial$Message$HidePopupMessage),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
...
var _elm_lang$elm_architecture_tutorial$View$modal = F2(
	function (fade, h) {
		return A2(
			_elm_lang$html$Html$div,
			{
...
var _elm_lang$elm_architecture_tutorial$View$lostConnectionModal = A2(
	_elm_lang$elm_architecture_tutorial$View$modal,
	false,
	A2(
		_elm_lang$html$Html$p,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('There is a problem communicating with the server. Refresh the page to try connecting again.'),
			_1: {ctor: '[]'}
		}));
var _elm_lang$elm_architecture_tutorial$View$loadingModal = function (fade) {
	return A2(
		_elm_lang$elm_architecture_tutorial$View$modal,
		fade,
		A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Please wait, loading transaction data...'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var _elm_lang$elm_architecture_tutorial$View$pageNamer = function (page) {
	var _p0 = page;
	switch (_p0.ctor) {
		case 'Accounts':
			return 'Accounts';
...
var _elm_lang$elm_architecture_tutorial$View$topNavigation = function (m) {
	return A5(
		_elm_lang$elm_architecture_tutorial$Helper_Html$navi,
		'navigation',
		m.page,
		_elm_lang$elm_architecture_tutorial$Message$ChoosePage,
		_elm_lang$elm_architecture_tutorial$View$pageNamer,
		{
			ctor: '::',
			_0: _elm_lang$elm_architecture_tutorial$Types$Accounts,
			_1: {
				ctor: '::',
				_0: _elm_lang$elm_architecture_tutorial$Types$Categories,
				_1: {
					ctor: '::',
					_0: _elm_lang$elm_architecture_tutorial$Types$Transactions,
					_1: {ctor: '[]'}
				}
			}
		});
...
var _elm_lang$elm_architecture_tutorial$View$view = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$map,
				_elm_lang$elm_architecture_tutorial$Message$AlertMsg,
				_wittjosiah$elm_alerts$Alert$view(model.alerts)),
			_1: {
				ctor: '::',
				_0: _elm_lang$elm_architecture_tutorial$View$topNavigation(model),
				_1: {
					ctor: '::',
					_0: function () {
						var _p1 = model.page;
					...
					_1: {
						ctor: '::',
						_0: model.lostConnection ? _elm_lang$elm_architecture_tutorial$View$lostConnectionModal : _elm_lang$html$Html$text(''),
						_1: {
							ctor: '::',
							_0: function () {
								var _p2 = model.popupMessage;
								if (_p2.ctor === 'Just') {
									return _elm_lang$elm_architecture_tutorial$View$popupMessageModal(_p2._0);
								} else {
									return _elm_lang$html$Html$text('');
								}
							}(),
							_1: {
								ctor: '::',
								_0: model.showLoadingModal ? _elm_lang$elm_architecture_tutorial$View$loadingModal(
									_elm_lang$elm_architecture_tutorial$Model$hasLoaded(model)) : _elm_lang$html$Html$text(''),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _elm_lang$elm_architecture_tutorial$Main$loadAllData = function () {
	var atfn = _elm_lang$elm_architecture_tutorial$Helper_Task$attempt2(
		_elm_lang$core$Basics$always(_elm_lang$elm_architecture_tutorial$Message$LostConnection));
	return _elm_lang$core$Platform_Cmd$batch(
		{
			...
			_0: A2(
				...
				function (data) {
					return A3(
						_elm_lang$elm_architecture_tutorial$Message$Load,
						_elm_lang$core$Maybe$Just(data),
						_elm_lang$core$Maybe$Nothing,
						_elm_lang$core$Maybe$Nothing);
				},
				_elm_lang$elm_architecture_tutorial$ProgramData$programData.accountBaaSPersister.get(
					{ctor: '[]'})),
			_1: {
				ctor: '::',
				_0: A2(
					...
					_elm_lang$elm_architecture_tutorial$ProgramData$programData.categoryBaaSPersister.get(
						{ctor: '[]'})),
				_1: {
					ctor: '::',
					_0: A2(
						...
						_elm_lang$elm_architecture_tutorial$ProgramData$programData.transactionBaaSPersister.get(
							{ctor: '[]'})),
					_1: {ctor: '[]'}
				}
			}
...
var _elm_lang$elm_architecture_tutorial$Main$todayCmd = A2(
	_elm_lang$core$Task$perform,
	function (t) {
		return _elm_lang$elm_architecture_tutorial$Message$SetTodaysDate(
	...
	return _elm_lang$html$Html$program(
		{
			init: {
				ctor: '_Tuple2',
				_0: _elm_lang$elm_architecture_tutorial$Model$empty,
				_1: _elm_lang$core$Platform_Cmd$batch(
					{
						ctor: '::',
						_0: _elm_lang$elm_architecture_tutorial$Main$loadAllData,
						_1: {
							ctor: '::',
